...
export const emailTokens = pgTable(
  'email_tokens',
  {
    id: text('id')
      .notNull()
      .$defaultFn(() => createId()), //createdId was used to generate Id since we can not add primaryKey twice and we need a way to generate ID
...
export const products = pgTable('products', {
  id: serial('id').primaryKey(), //serial would increment the product id by 1, 1,2,3,4

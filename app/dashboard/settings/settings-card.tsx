...
export default function SettingsCard(session: SettingsForm) {
  ...
  const { execute, status } = useAction(settings, {
    onSuccess: (data) => {
      ...
      // This error catches any error we throw or return
      if (data?.error) setError(data.error);
    },
    onError: (error) => {
      // This catches the server error
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Switch
                      disabled={
                        status === 'executing' ||
                        session.session.user.isOAuth === true //this checkes if the user signed in using oAuth and disables the button toggle
                      }
                      checked={field.value}
